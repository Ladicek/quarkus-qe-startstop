...
public enum CodeQuarkusExtensions {
    ...
    QUARKUS_RESTEASY_REACTIVE("quarkus-rest", "REST", "ignored", true),
    QUARKUS_RESTEASY_REACTIVE_JSONB("quarkus-rest-jsonb", "REST JSON-B", "ignored", true),
...
//    QUARKUS_SMALLRYE_REACTIVE_MESSAGING_AMQP("quarkus-smallrye-reactive-messaging-amqp", "SmallRye Reactive Messaging - AMQP Connector", "ur3", true),
    QUARKUS_MESSAGING_KAFKA("quarkus-messaging-kafka", "Messaging - Kafka Connector", "ignored", true),
    QUARKUS_MESSAGING_MQTT("quarkus-messaging-mqtt", "Messaging - MQTT Connector", "ignored", false),
    QUARKUS_MESSAGING_RABBITMQ("quarkus-messaging-rabbitmq", "Messaging - RabbitMQ Connector", "ignored", false),
    ...
    QUARKUS_KEYCLOAK_ADMIN_CLIENT("quarkus-keycloak-admin-resteasy-client", "Keycloak Admin RESTEasy Client", "ignored", false),
    QUARKUS_KEYCLOAK_ADMIN_CLIENT_REACTIVE("quarkus-keycloak-admin-rest-client", "Keycloak Admin REST Client", "ignored", false),
    ...
    QUARKUS_OIDC_TOKEN_PROPAGATION("quarkus-resteasy-client-oidc-token-propagation", "RESTEasy Client - OpenID Connect Token Propagation", "ignored", false),
    ...
    LANGCHAIN4J_AI_GEMINI("quarkus-langchain4j-ai-gemini", "LangChain4j AI Gemini", "ignored", false),
    LANGCHAIN4J_ANTHROPIC("quarkus-langchain4j-anthropic", "LangChain4j Anthropic", "ignored", false),
    LANGCHAIN4J_AZURE_OPENAI("quarkus-langchain4j-azure-openai", "LangChain4j Azure OpenAI", "ignored", false),
    LANGCHAIN4J_BEDROCK("quarkus-langchain4j-bedrock", "LangChain4j Bedrock", "ignored", false),
    LANGCHAIN4J_CHROMA("quarkus-langchain4j-chroma", "LangChain4j Chroma", "ignored", false),
    LANGCHAIN4J_CORE("quarkus-langchain4j-core", "LangChain4j Core", "ignored", false),
    LANGCHAIN4J_EASY_RAG("quarkus-langchain4j-easy-rag", "LangChain4j Easy RAG", "ignored", false),
    LANGCHAIN4J_HUGGING_FACE("quarkus-langchain4j-hugging-face", "LangChain4j Hugging Face", "ignored", false),
    LANGCHAIN4J_INFINISPAN("quarkus-langchain4j-infinispan", "LangChain4j Infinispan embedding store", "ignored", false),
    LANGCHAIN4J_JLAMA("quarkus-langchain4j-jlama", "LangChain4j Jlama", "ignored", false),
    LANGCHAIN4J_LLAMA3_JAVA("quarkus-langchain4j-llama3-java", "LangChain4j Llama3 Java", "ignored", false),
    LANGCHAIN4J_MILVUS("quarkus-langchain4j-milvus", "LangChain4j Milvus embedding store", "ignored", false),
    LANGCHAIN4J_MISTRAL_AI("quarkus-langchain4j-mistral-ai", "LangChain4j Mistral AI", "ignored", false),
    LANGCHAIN4J_MCP("quarkus-langchain4j-mcp", "LangChain4j Model Context Protocol client", "ignored", false),
    LANGCHAIN4J_NEO4J("quarkus-langchain4j-neo4j", "LangChain4j Neo4j embedding store", "ignored", false),
    LANGCHAIN4J_OLLAMA("quarkus-langchain4j-ollama", "LangChain4j Ollama", "ignored", false),
    LANGCHAIN4J_OPENAI("quarkus-langchain4j-openai", "LangChain4j OpenAI", "ignored", false),
    LANGCHAIN4J_PGVECTOR("quarkus-langchain4j-pgvector", "LangChain4j pgvector embedding store", "ignored", false),
    LANGCHAIN4J_PINECONE("quarkus-langchain4j-pinecone", "LangChain4j Pinecone embedding store", "ignored", false),
    LANGCHAIN4J_QDRANT("quarkus-langchain4j-qdrant", "LangChain4j Qdrant embedding store", "ignored", false),
    LANGCHAIN4J_REDIS("quarkus-langchain4j-redis", "LangChain4j Redis embedding store", "ignored", false),
    LANGCHAIN4J_TAVILY("quarkus-langchain4j-tavily", "LangChain4j Tavily Web Search Engine", "ignored", false),
    LANGCHAIN4J_VERTEX_AI("quarkus-langchain4j-vertex-ai", "LangChain4j Vertex AI", "ignored", false),
    LANGCHAIN4J_VERTEX_AI_GEMINI("quarkus-langchain4j-vertex-ai-gemini", "LangChain4j Vertex AI Gemini", "ignored", false),
    LANGCHAIN4J_WATSONX("quarkus-langchain4j-watsonx", "LangChain4j Watsonx", "ignored", false),
    LANGCHAIN4J_WEAVIATE("quarkus-langchain4j-weaviate", "LangChain4j Weaviate", "ignored", false),
    LANGCHAIN4J_MEMORY_STORE_MONGODB("quarkus-langchain4j-memory-store-mongodb", "Quarkus Langchain4j - Memory Store - MongoDB", "ignored", false),
    LANGCHAIN4J_MEMORY_STORE_REDIS("quarkus-langchain4j-memory-store-redis", "Quarkus Langchain4j - Memory Store - Redis", "ignored", false),
    LANGCHAIN4J_COHERE("quarkus-langchain4j-cohere", "Quarkus LangChain4j Cohere", "ignored", false),
    LANGCHAIN4J_OPENSHIFT_AI("quarkus-langchain4j-openshift-ai", "Quarkus LangChain4j OpenShift AI", "ignored", false),
    LANGCHAIN4J_PARSERS_BASE("quarkus-langchain4j-parsers-base", "Quarkus LangChain4j Parsers Base", "ignored", false),
    LANGCHAIN4J_OIDC_CLIENT_MCP_AUTH_PROVIDER("quarkus-langchain4j-oidc-client-mcp-auth-provider", "LangChain4j OpenId Connect (OIDC) Client ModelAuthProvider", "ignored", false),
    LANGCHAIN4J_OIDC_MCP_AUTH_PROVIDER("quarkus-langchain4j-oidc-mcp-auth-provider", "LangChain4j OpenId Connect (OIDC) ModelAuthProvider", "ignored", false),
    LANGCHAIN4J_OIDC_MODEL_AUTH_PROVIDER("quarkus-langchain4j-oidc-model-auth-provider", "LangChain4j OpenId Connect (OIDC) ModelAuthProvider", "ignored", false),
    LANGCHAIN4J_CHATBOT("quarkus-langchain4j-chatbot", "Langchain4j - Codestarts - Chatbot", "ignored", false),
    CAMEL_QUARKUS_LANGCHAIN4J("camel-quarkus-langchain4j", "Camel langChain4j", "ignored", false),
    CAMEL_QUARKUS_LANGCHAIN4J_CHAT("camel-quarkus-langchain4j-chat", "Camel langChain4j Chat", "ignored", false),
    CAMEL_QUARKUS_LANGCHAIN4J_TOKENIZER("camel-quarkus-langchain4j-tokenizer", "Camel LangChain4j Tokenizer", "ignored", false),
    CAMEL_QUARKUS_LANGCHAIN4J_TOOLS("camel-quarkus-langchain4j-tools", "Camel LangChain4j Tools", "ignored", false),
    CAMEL_QUARKUS_LANGCHAIN4J_WEB_SEARCH("camel-quarkus-langchain4j-web-search", "Camel LangChain4j Web Search", "ignored", false);
